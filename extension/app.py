...
def Scan():
   ...
   index = 0
   if visualcomp == "true": vis = [0] * len(inner_urls)
   else: vis = []
   if distin == "true": dist = [0] * len(inner_urls)
   else: dist = []
   if text_image == "true": te_im = [0] * len(inner_urls)
   else: te_im = []
   if textc == "true": tex = [0] * len(inner_urls)
   else: tex = []
   if image == "true": ima = [0] * len(inner_urls)
   else: ima = []
   threads = []
